...
#define D_CAMBIAR_ENJUEGO
#define D_CAMBIAR_ENPAUSA
#define D_CAMBIAR_INICIOAUTO
#define D_CAMBIAR_EQUIPOS_BLOQUEADOS
#define D_CAMBIAR_SKINOBLIGATORIO
#define D_CAMBIAR_COLOR_ALPHA
#define D_CAMBIAR_COLOR_BETA